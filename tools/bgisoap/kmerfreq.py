...
def main():
    ...
    #Custom params
    parser.add_option("-q", "--quality_cutoff", dest="quality_cutoff", help="Quality cutoff")
    ...
    parser.add_option("-n", "--output_kmer_index", dest="output_kmer_index",
        help="Output kmer index with frequency results?")
    ...
    parser.add_option("", "--freq", dest='freq', help="Frequency information")
    parser.add_option("", "--filelist", dest='filelist', help="List of input files")
